...
const SLIDES = [
  { src: '/images/work/SLAB-final.png', alt: 'SLAB final design — full page mockup', width: 5178, height: 21633 },
];

export default function AngiSlabCarousel() {
  ...
  return (
    <div
      ...
      aria-label="SLAB final design page mockups"
    >
